...
import { 
    ...
    Hash, Globe, User, XCircle, Mail, Map, Sparkles, X
    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-4xl mx-auto pb-10">
            <div class="mb-6">
                ...
                <h2 class="text-3xl font-black text-gray-800 tracking-tighter uppercase">Cadastrar Novo Fornecedor</h2>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <button 
                        ...
                        class="bg-emerald-600 hover:bg-emerald-700 active:scale-95 active:shadow-lg text-white px-12 py-4 rounded-xl font-bold flex items-center gap-2 transition-all duration-200 shadow-xl shadow-emerald-500/20 hover:shadow-xl disabled:opacity-50 disabled:scale-100 transform cursor-pointer"
                    >
